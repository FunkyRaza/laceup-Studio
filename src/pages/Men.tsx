    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const menProducts = productsRes.data.filter(
                    (p: Product) => p.isActive && (p.gender?.toLowerCase() === 'men' || p.gender?.toLowerCase() === 'unisex')
                );
                ...
                <div className="container-custom">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
                            <span className="text-sm font-semibold tracking-wide">MEN'S COLLECTION</span>
                        </div>
                        <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
                            Men's Fashion
                        </h1>
                        <p className="text-lg md:text-xl text-gray-300">
                            Elevate your style with our curated collection of premium men's fashion.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="container-custom py-4">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <select
                            ...
                            className="px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-700 font-medium focus:outline-none focus:ring-2 focus:ring-gray-900"
                        >
